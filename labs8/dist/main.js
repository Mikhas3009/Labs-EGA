...
if (isCorrectTask) {
    ...
    while (true) {
        ...
        console.log('Выбираемый предмет:', maxItem.getNumber(), ' Вес :', maxItem.getWeight(), "Полезность: ", maxItem.getUtility(), "Удельная полезность: ", maxItem.getUtility() / maxItem.getWeight());
